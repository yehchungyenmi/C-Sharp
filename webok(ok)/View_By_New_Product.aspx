<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="View_By_New_Product.aspx.cs" Inherits="View_By_New_Product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_產品" runat="server" 
        ...
        SelectCommand="SELECT * FROM [資料表1] WHERE(登錄日期) > Date()">
