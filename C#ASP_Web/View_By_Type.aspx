...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
        ...
        <table class="col-md-12">
            <tr>
                <td style="width: 10%; height: 40px; background-color: #FFFFCC; vertical-align: top">
                    ...
                    <asp:DropDownList ID="DropDownList_By_商品類別" runat="server" Height="40px" Width="100%"
                        valign="top" AutoPostBack="True" DataSourceID="SqlDataSource_商品類別" DataTextField="商品類別" DataValueField="商品類別" Font-Size="Large">
                    </asp:DropDownList>         
     ...
     <asp:SqlDataSource ID="SqlDataSource_商品類別" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource_廠商商品" runat="server"
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
        SelectCommand="SELECT * FROM [資料表1] WHERE [商品類別] = @商品類別">
          <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList_By_商品類別"
